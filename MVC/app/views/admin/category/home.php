...
<div class="container-fluid p-0 m-0">
    <div class="row g-0 m-5">
        ...
        <div class="col-md-6 offset-md-2">
            ...
            <h1 class="text-center text-primary pb-4">Create Category</h1>
            <form action="<?php echo URLROOT . 'category/create' ?>" method="post">
                <div class="mb-3 row">
                    <label for="name" class="col ps-4 col-form-label">Category Name</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control <?php echo !empty($data['name_err']) ? 'is-invalid' : ''; ?>" id="name" placeholder="Enter Name" name="name">
